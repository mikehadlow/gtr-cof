import type { State, ModalState } from "../../types";
...
export function createCheckbox(modal: HTMLDivElement, labelText: string, checkboxState: boolean, onClick: (isChecked: boolean) => void) {
